...
headers() = Array("ticker", "Date", "Open", "High", "Low", "Close", "Volume", " ", "Ticker", "Year_Change", "Percent_Change", "Stock_Volume", " ", " ", " ", "Ticker", "Value")
...
Next MainWs
    ...
    If (Yealry_Price_Change_Percent > Max_Percent) Then
